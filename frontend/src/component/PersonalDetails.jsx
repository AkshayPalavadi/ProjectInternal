...
const PersonalDetails = ({ data, setData, setActive, errors,nextStep, setErrors }) => {
  ...
  if (name === "alternativePhone") {
    ...
    if (type === 'file') {
      ...
      if (name === 'marriageCertificate') setMarriagePreview(URL.createObjectURL(file));
    ...
    <div className="form-wrap">
      ...
      <div className="form-grid">
        ...
        <div className="field">
          ...
          <input name="middleName" value={data.middleName} onChange={handleChange} />
        </div>
        ...
        <div className="field">
          ...
          <input name="fatherName" value={data.fatherName || ''} onChange={handleChange} />
          {errors.fatherName && <small className="err">{errors.fatherName}</small>}
        </div>

        <div className="field">
          <label>Mother’s Name <span className="required-star">*</span></label>
          <input name="motherName" value={data.motherName || ''} onChange={handleChange} />
          {errors.motherName && <small className="err">{errors.motherName}</small>}
        </div>
        <div className="field">
...
/>
        ...
        <div className="field full">
          ...
          <input type="file" name="photo" accept="image/jpeg, image/png" alt='Image' onChange={handleChange} />
          {photoPreview && (
            <img
              src={photoPreview}
              alt="Preview"
        ...
        <div className="field full">
          ...
          />
          {errors.currentAddress && <small className="err">{errors.currentAddress}</small>}
        </div>
        ...
        <div className="field">
          ...
          <small className='err'>{errors.landmark}
          </small>
        </div>
...
/>
        ...
        <div className="field">
          <label>Village</label>
          <input name="village" value={data.village || ''} onChange={handleChange} />
        </div>
...
<div className="field">
  ...
  {errors.state && <small className="err">{errors.state}</small>}
        ...
        <div className="field">
          <label>Emergency Contact Number <span className="required-star">*</span></label>
          <input
            type="tel"
            ...
            placeholder="Enter 10-digit number"
          />
          {errors.emergencyNumber && <small className="err">{errors.emergencyNumber}</small>}
        </div>

        <div className="field">
          <label>Nominee 1 <span className="required-star">*</span></label>
          <input name="nominee1" value={data.nominee1 || ''} onChange={handleChange} />
          {errors.nominee1 && <small className="err">{errors.nominee1}</small>}
        </div>

        <div className="field">
          <label>Nominee 2 <span className="required-star">*</span></label>
          <input name="nominee2" value={data.nominee2 || ''} onChange={handleChange} />
        ...
        <div className="field">
          ...
          />
          {errors.aadharNumber && <small className="err">{errors.aadharNumber}</small>}
        </div>

        <div className="field">
          <label>Upload Aadhar Card <span className="required-star">*</span></label>
          <input type="file" name="aadharUpload" accept="image/*,.pdf" onChange={handleChange} />
          {errors.aadharUpload && <small className="err">{errors.aadharUpload}</small>}
        </div>
        ...
        <div className="field">
          ...
          />
          {errors.panNumber && <small className="err">{errors.panNumber}</small>}
        </div>

        <div className="field">
          <label>Upload PAN Card <span className="required-star">*</span></label>
          <input type="file" name="panUpload" accept="image/*,.pdf" onChange={handleChange} />
          {errors.panUpload && <small className="err">{errors.panUpload}</small>}
        </div>

        <div className="field full checkbox-field">
          <label>
            <input type="checkbox" name="isMarried" checked={data.isMarried || false} onChange={handleChange} /> Married?
          </label>
        </div>
        ...
        {data.isMarried && (
          <div className="field full">
            ...
            <input type="file" name="marriageCertificate" accept="image/*,.pdf" onChange={handleChange} />
            {errors.marriageCertificate && <small className="err">{errors.marriageCertificate}</small>}
          </div>
        )}
      </div>
