    ...
    <Router>
      <Routes>
        ...
        >
          ...
          <Route
            path="employees"
            element={<AdminEmployees darkMode={darkMode} />}
          />
          <Route path="carriers" element={<AdminCarrier darkMode={darkMode} />} />
          <Route path="Carriers1" element={<AdminCarrier1 darkMode={darkMode} />} />
          <Route
            path="job-applied"
            element={<JobApplicants darkMode={darkMode} />}
          />
          <Route path="onhold" element={<OnHold darkMode={darkMode} />} />
          <Route path="hired" element={<Hired darkMode={darkMode} />} />

          <Route
            path="traininganddevelopment"
            element={<TrainingDevelopment darkMode={darkMode} />}
          />
          <Route path="OnGoing" element={<OnGoing darkMode={darkMode} />} />
          <Route
            path="InProgress"
            element={<InProgress darkMode={darkMode} />}
          />
          {/* ✅ FIXED: No leading /admin in nested path */}
          <Route
            path="CompletedTraining"
            element={<CompletedTraining darkMode={darkMode} />}
          />
          <Route path="ReportPage" element={<ReportPage darkMode={darkMode} />} />
          <Route path="FreshersTrainingAssignment" element={<FreshersTrainingAssignment darkMode={darkMode} />} />
          <Route path="TrainingModule" element={<TrainingModule darkMode={darkMode} />} />
          <Route path="CertificatePage" element={<CertificatePage darkMode={darkMode} />} />
          <Route path="TrainingAssignment" element={<TrainingAssignment darkMode={darkMode} />} />
