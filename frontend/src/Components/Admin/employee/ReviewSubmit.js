    ...
    <div className="form-wrap">
      ...
      <div className="review-card">
        ...
        <table className="review-table">
          <tbody>
            ...
            {renderField(
              "Photo",
              personal.photo ? personal.photo.name : "No file uploaded"
            )}
          </tbody>
        </table>
        ...
        <table className="review-table">
          <tbody>{renderField("Job Type", professional.jobType)}</tbody>
        </table>
      ...
      {submitAttempted && Object.keys(submitErrors).length > 0 && (
        <div className="submit-err">
          {" "}
          Please fill the required fields highlighted above. Missing:{" "}
          {Object.keys(submitErrors).join(", ")}{" "}
        </div>
      )}
