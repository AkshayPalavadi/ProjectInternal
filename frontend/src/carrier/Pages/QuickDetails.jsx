...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    body.append("alternatePhone", formData.alternatePhone);

    body.append("course", formData.course === "Other" ? formData.otherCourse : formData.course);
    body.append("department", formData.department);
    body.append("college", formData.college);
    body.append("yearOfPassing", formData.yearOfPassing);
    
    body.append("gradeType", formData.gradeType);
    body.append("cgpa", formData.cgpa);

    body.append("employeeType", formData.employeeType);
    body.append("companyName", formData.companyName);
    body.append("experienceYears", formData.experienceYears);
    ...
    const response = await fetch(
      "https://public-website-drab-ten.vercel.app/api/candidates/save",
      {
        method: "POST",
        body: body, // NO need for headers with FormData
      }
    );
...
//   try {
//     // Prepare form data for API (multipart/form-data)
