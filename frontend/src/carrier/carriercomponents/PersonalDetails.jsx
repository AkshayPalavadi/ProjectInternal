...
/>
  ...
  onChange={(e) => {
    ...
    if (value.length <= 10) setData({ ...data, alternativePhone: value });
  }}
...
/>
        ...
        <div className="field full">
          ...
          <input type="file" name="photo" accept="image/jpeg, image/jpg" onChange={handleChange} />
  ...
  value={data.pincode}
  onChange={(e) => {
    const value = e.target.value.slice(0, 6); // Indian pincode limit
